---
title: Kubernetes Port Formward in a GitHub Action
...
the original post, I just report them here to make this post self consistent.

Difference from the original posts are in the deply phase. While they suggest to perform port forwarding in the main action before doing any
operation, I prefer running it within a container service as suggested but github action team.
