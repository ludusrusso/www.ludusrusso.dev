  ...
  return (
    <div className="relative bg-white overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-indigo-600 xl:inline">Ludovico</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Mi piace sperimentare e scoprire nuove tecnologie. Faccio molti esperimenti online in livestream,
                seguimi per scoprire ogni giorno qualcosa di nuovo insieme a tanti programmatore esperti!
              </p>
              <div className="mt-5 sm:mt-8 flex sm:justify-center lg:justify-start gap-5">
                {icons.map((icon) => (
                  <div key={icon.name}>
                    ...
                    >
                      <icon.icon className="h-16 sm:h-20 w-16 sm:w-20" aria-hidden="true" />
                    </a>
                  </div>
                ))}
              </div>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="/ludusrusso.jpg" alt="" />
      </div>
    </div>
  );
};
