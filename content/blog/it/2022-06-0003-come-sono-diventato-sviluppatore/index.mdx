...
2. Il 75% della mia classe voleva fare il medico, mi sembrava una cosa un po' inflazionata a quei tempi!

Il quinto anno passa veloce tra pallavolo, compiti, preparazione agli esami, e ovviamente arrivo alla primavera senza la minima
idea di quello che avrei fatto.

**Poi una mattina d'aprile arriva la svolta**
...
Per il mio cervello è stata un'eternità, ma credo di averci messo meno di 1ms per prendere quella decisione, alzare la mano
e dire:
...
in realtà perchè pensavo che gli ingegneri facessero solo ponti e case, ma in quel momento avevo deciso, quale
...
sempre divertito a **smontare le cose**, non ad aggiustarle.
...
La triennale in Val d'Aosta è stato un periodo veramente bello per me, a parte l'università con tante cose
...
mi divertivo tantissimo anche con i corsi di elettronica, e (un po' meno) con la meccanica.
...
più foto che la vedono da diverse angolazioni. Ricordo che avevo trovato un software open source
...
La tesi l'ho fatta su un progetto di Robotica e Computer Vision, si trattava sempre di ricostruzione 3D, ma in questo caso la telecamera
era una sola che si muoveva sul robot, e lo scopo non era ricostruire l'ambiente ma capire come il robot si stesse muovendo all'interno
dell'ambiente. È stato molto divertente, e sicuramente stavo iniziando a capire cosa vuol dire scrivere un software complesso.
...
Gabriele aveva deciso di partire per la Cina, io non volevo rimanera in università (dove comunque avevo mantenuto un posto di collaborazione alla fine del PhD).

Un po' all'avventura, forte del fatto che la mia allora fidanzata (ed attuale moglie), aveva un lavoro a Milano, ho lasciato il mio posto in università
